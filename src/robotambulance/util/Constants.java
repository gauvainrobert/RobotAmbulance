...
public class Constants {
	...
	public static final int Kp = 2700; //2000//1600//1600
	public static final int Ki = 0; //80//30//50
	public static final int Kd = 0; //3000//500//50
	public static final int offset = 35; //47//40
	public static final int offsetSimpleLine = 50; //40
	public static final int offsetSingleCaptor = 44;
	...
	public static float avoidRoad = 10000f;
